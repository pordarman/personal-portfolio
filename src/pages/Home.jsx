    ...
    <div className="w-full h-full overflow-y-auto overflow-x-hidden scroll-smooth">
      <section className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full h-full px-4 text-center">
          ...
          >
            <motion.h1 variants={itemVariants} className="text-4xl md:text-7xl font-extrabold tracking-tight mb-2 md:mb-4 drop-shadow-2xl">
              Hi, I'm Ali İhsan Çelik
            </motion.h1>

            <motion.h2 variants={itemVariants} className="text-lg md:text-3xl text-blue-200 font-medium mb-4 md:mb-6 max-w-2xl">
              3rd Year Computer Engineering Student
            </motion.h2>

            <motion.p variants={itemVariants} className="text-gray-300 text-base md:text-xl max-w-3xl leading-relaxed mb-8 md:mb-10">
            ...
            <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 mb-6 md:mb-8 w-full sm:w-auto">
              <button
            ...
            <motion.div variants={itemVariants} className="flex gap-6 items-center border-t border-white/10 pt-6">
