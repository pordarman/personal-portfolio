...
export const otherProjects = [
  {
    ...
    readme: `
![Me with the Drone](../src/assets/teknofest_me_drone.webp)
...
![Our Team](../src/assets/teknofest_team.webp)
...
![QGroundControl Screenshot](../src/assets/qgroundcontrol_ss.webp)
*Pre-flight mission planning and simulation in QGroundControl.*

![Code Screenshot](../src/assets/code_ss.webp)
...
`
  ...
  **Core Features:**
  ...
  ![In-game Screenshot 1](../src/assets/spiritfall_preview.webp)
