...
function NotFound() {
  ...
  return (
    <div className="flex items-center justify-center h-full text-white font-mono p-4">
      <div className="bg-slate-800 border border-red-500/30 rounded-lg shadow-xl w-full max-w-3xl p-6">
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-300 mb-4">Görünüşe göre yanlış bir yola saptınız. Ana sayfaya dönmeyi deneyin.</p>
          <Link 
            to="/" 
